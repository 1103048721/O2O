			...
			<div class="nan">
				...
				<div class="di">
					<el-table style="width: 100%;" :data="tableData">
						...
						<el-table-column label="团购价/结算价" prop="spj" width="150">
						</el-table-column>
					...
					<el-dialog :title="dialogTitle" width="50%" :visible.sync="iconFormVisible">
						<el-form :inline="true" :model="userInfo" class="demo-form-inline">
							...
							<el-form-item label="团购价/结算价">
								<el-input v-model="userInfo.spj" placeholder="团购价/结算价"></el-input>
							</el-form-item>
...
<style>
	...
	#sp .el-button--primary.is-active,
	.el-button--primary:active {
		background: #FF8800 !important;
		border-color: #FF8800 !important;
	}

	#sp .el-button--primary:focus,
	...
	#sp .button .el-button--primary:nth-of-type(1) {
		background: #0A82F8;
		border: #0A82F8;
	}

	#sp .button .el-button--primary:nth-of-type(1):active {
		background: #0A82F8 !important;
		border-color: #0A82F8 !important;
	}

	#sp .button .el-button--primary:nth-of-type(1):focus,
	.button .el-button--primary:nth-of-type(1):hover {
		background: #0A82F8 !important;
		border-color: #0A82F8 !important;
	}

	#sp .button .el-button--primary:nth-of-type(2) {
		background: #00BE7F;
		border: #00BE7F;
	}

	#sp .button .el-button--primary:nth-of-type(2):active {
		background: #00BE7F !important;
		border-color: #00BE7F !important;
	}

	#sp .button .el-button--primary:nth-of-type(2):focus,
